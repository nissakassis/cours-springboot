...
////import org.junit.Test; // icic dans run as -> configurations -> changet Junit
////import org.junit.jupiter.api.Test; run as Junit 5
...
public class PersonRepositoryTest {
	...
	public void testDelete() {
		Person p1 = new Person(1L,"Wayne", "Bruce", 45);
		Person p2 = new Person(1L,"Kent", "Clark", 45);
	...
	// Methode qui teste que si on appelle la methode findById() avec une valeur inexistante,4
...
//	@Test
//	public void testFindAll() {
//		Person p1 = new Person("Wayne", "Bruce", 45);
//		Person p2 = new Person("Kent", "Clark", 45);
//
//		List<Person> persons = Arrays.asList(p1, p2);
//
//		personRepository.saveAll(persons);
...
//	@Test
//	public void testFindById() {
//		Person savedInDb = personRepository.save(new Person("Doe", "John", 40));
//		Person getFromDb = personRepository.findById(savedInDb.getId()).get();
//
//		assertEquals(savedInDb, getFromDb);
//		assertThat(getFromDb).isEqualTo(savedInDb);
...
//	@Test
//	public void testSave() {
//		Person savedInDb = personRepository.save(new Person("Wick", "John", 40));
//		Person getFromDb = personRepository.findById(savedInDb.getId()).get();
//
//		assertEquals(savedInDb, getFromDb);
//		assertThat(getFromDb).isEqualTo(savedInDb);
...
//	public void testFindAll() {
//		Person p1 = new Person("Wayne", "Bruce", 45);
//		Person p2 = new Person("Kent", "Clark", 40);
//
//		List<Person> persons = Arrays.asList(p1, p2);
...
//	public void testFindById() {
//
//		Person savedInDb = personRepository.save(new Person("Doe", "Jhon", 40));
//		Person getFromDb = personRepository.findById(savedInDb.getId()).get();
//		
//		assertEquals(savedInDb, getFromDb);
//		assertThat(getFromDb.equals(savedInDb));
//	}
//}
